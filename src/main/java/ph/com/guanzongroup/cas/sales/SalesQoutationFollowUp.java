...
import ph.com.guanzongroup.cas.sales.model.Model_Sales_Quotations_FollowUp;
...
public class SalesQoutationFollowUp extends Parameter {
     ...
     */
    Model_Sales_Quotations_FollowUp poModel;
    /**
     ...
     */
    @Override
    public Model_Sales_Quotations_FollowUp getModel() {
        return poModel;
    }
    ...
    public JSONObject isEntryOkay() throws SQLException {
        ...
        if (poModel.getTransactionNo().isEmpty()) {
            poJSON.put("result", "error");
        ...
        if (poModel.getFollowUpType().isEmpty()) {
            poJSON.put("result", "error");
